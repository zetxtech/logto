...
import AzureFormFields from './AzureFormFields';
import S3FormFields from './S3FormFields';
...
function StorageSettings() {
  ...
  return (
    <>
      <PageMeta titleKey="tenants.title" />
      <div className={styles.container}>
        <FormCard
          title={<DangerousRaw>Storage Provider</DangerousRaw>}
          description="tenants.settings.description"
        >
          ...
          <FormProvider {...methods}>
            <form className={styles.form}>
              <FormField
                title={
                  <DangerousRaw>
                    {t('tenants.storage.provider', { defaultValue: 'Provider' })}
                  </DangerousRaw>
                }
              >
                <RadioGroup
