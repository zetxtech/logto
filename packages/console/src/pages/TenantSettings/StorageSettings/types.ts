/* eslint-disable import/no-unused-modules -- Internal module exports */
export type StorageProvider = 'S3Storage' | 'AzureStorage';

const storageProviders = new Set<string>(['S3Storage', 'AzureStorage']);
